        ...
        for i in range(self.iterations):
            for sentenceindex in range(len(traindata)):
                ...
                actualtagtransitions = [(traindata[sentenceindex][index][1], traindata[sentenceindex][index + 1][1],
                                         traindata[sentenceindex][index + 2][1])
                                        for index in range(len(traindata[sentenceindex]) - 2)]
                ...
                if sentenceindex == 0:  # for first sentence, randomly initialise tags
                    ...
                    predtagtransitions = [(predtagsentence[index][1], predtagsentence[index + 1][1], predtagsentence[index + 2][1])
                                          for index in range(len(predtagsentence) - 2)]
